...
class LineController (val inOrientation : BoardOrientation = BoardOrientation.WHITE) {
    ...
    private fun tryMove(move: Move): Boolean {
        ...
        // Trim future moves when branching from the middle of the line
    ...
    /**
     * Loads a line from UCI move strings and places the board at [targetPly].
     * All moves are stored so undo/redo still works across the full line.
     */
